...
const How: React.FC<HowProps> = ({ showHowTo }) => {
  return (
    <div className="mt-5 relative bg-secondary rounded text-left pl-[3rem] pt-5 pb-5">
      ...
      <div className="pr-[3rem] mb-5">
        ...
        <p className="mb-5">
          ...
          English), translation of that word in foreign language and image.
          Study tells that memorizing words is way easier if you associate them
          with images!
        </p>
        <p>
